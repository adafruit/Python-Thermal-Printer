...
# This version uses bitmaps (in the 'gfx' subdirectory)
# to render the puzzle rather than text symbols.
#
...
bg      = Image.open('gfx/background.jpg')
numbers = [0 for x in range(9)]
