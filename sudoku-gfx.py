...
# Adafruit Industries.
# This version uses bitmaps (in the 'gfx' subdirectory) to render
# the puzzle rather than text symbols.  See sudoku-txt for a
# different Sudoku example that's all text-based.
