    ...
    for puzzle in puzzles:
        ...
        if len(args) > 0:
            ...
            if answer is None:
                ...
                printer.print(printboard(answer))
    printer.feed(3)
        ...
        for pos in xrange(81):
            if board[pos] is None:
                ...
                if len(numbers) == 1:
                    ...
                    guess, count = pickbetter(guess, count,
                                              [(pos, n) for n in numbers])
...
def posfor(x, y, axis=0):
    ...
    if axis == 1:
        return y * 9 + x
    return ((0, 3, 6, 27, 30, 33, 54, 57, 60)[x] +
...
def entriesforboard(board):
    return [(pos, board[pos]) for pos in xrange(81)
